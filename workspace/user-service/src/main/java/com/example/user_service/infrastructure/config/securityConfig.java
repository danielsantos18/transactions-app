...
public class securityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationEntryPoint authEntryPoint)
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/login", "/auth/register", "/users/find/{username}").permitAll()
    ...
    public AuthenticationManager authenticationManager(PasswordEncoder passwordEncoder) {
        ...
        authProvider.setUserDetailsService(userDetailsConfig); // Aquí usamos UserDetailsConfig
